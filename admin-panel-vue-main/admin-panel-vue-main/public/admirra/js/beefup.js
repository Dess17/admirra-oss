...
(function (r) {
	...
	r.fn.beefup = function (o) {
		...
		this.open = function (o, s) {
			...
			o.each(function () {
				var e = r(this),
					...
					i =
						t.animation === "slide" ? "slideDown"
						: t.animation === "fade" ? "fadeIn"
						: "show";
		...
		this.close = function (e, o) {
			...
			e.each(function () {
				var e = r(this),
					...
					n = e.find(t.content + ":first"),
					i =
						t.animation === "slide" ? "slideUp"
						: t.animation === "fade" ? "fadeOut"
						: "hide";
		...
		this.scroll = function (e) {
			...
			r("html, body")
				.animate({ scrollTop: e.offset().top + t.scrollOffset }, t.scrollSpeed)
				.promise()
				.done(function () {
